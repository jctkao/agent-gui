...
Drive the agent loop using `rig-core` (Ollama provider), replacing the hand-rolled reqwest implementation. Handles tool dispatch, user approval for terminal commands, and multi-turn conversation history.
