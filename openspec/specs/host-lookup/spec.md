...
Provide an agent skill that looks up a host's IP address by name from a user-maintained `hosts.txt` file, shipped as a repo-tracked skill folder and invoked via a PowerShell script.
