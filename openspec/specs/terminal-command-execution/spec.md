...
Defines how the AI agent injects shell commands into the active terminal for user review and execution, and how results are reported back to the agent loop.
